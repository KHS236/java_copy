package CH01;
//	생성자 메서드
//	ex) Scanner sc = new "Scanner(System.in)" << 이부분
//	생성자 메서드 Scanner();

//	객체 생성시 "최초 1회 한 번만" 호출되는 메서드
//	생성된 객체 내에서는 사용이 불가능
//	객체 생성시에 필요한 메모리공간 형성과 " 초기값 부여 " 에 사용
//	생성자 메서드의 이름은 클래스 이름과 동일하게 부여해야함
//	생성자 메서드는 반환 자료형을 가지지 않음.

//	생성자 함수를 클래스 내에 명시하지 않으면(코드삽입 x)
...
class C08Simple{
	...
	C08Simple(){ //생성자 메서드
		System.out.println("C08Simple() 생성자 호출"); //기본적으로 호출되면 false값 반환
//		초기값 설정
		this.n1=10;
		this.n2=10.10;
		this.n3=true;
...
public class C08ConstructorMain생성자 {

	public static void main(String[] args) {

		C08Simple ob0 = new C08Simple();
		C08Simple ob1 = new C08Simple(10);
		C08Simple ob2 = new C08Simple(10,5.1);
		C08Simple ob3 = new C08Simple(10,5.2,true);
		C08Simple ob4 = new C08Simple(10,5.3,true,"TEST");
